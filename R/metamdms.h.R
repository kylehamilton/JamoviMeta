...
metamdmsOptions <- if (requireNamespace('jmvcore')) R6::R6Class(
    "metamdmsOptions",
...
metamdmsResults <- if (requireNamespace('jmvcore')) R6::R6Class(
...
metamdmsBase <- if (requireNamespace('jmvcore')) R6::R6Class(
    "metamdmsBase",
...
metamdms <- function(
    ...
    if ( ! requireNamespace('jmvcore'))
        stop('metamdms requires jmvcore to be installed (restart may be required)')
